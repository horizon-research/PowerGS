...
cd $render_code_dir
python3 FR_Ours/curve_fit_scene.py --root_dir /workspace/PowerGS/models/"$method_name"/"$scene_type"/"$scene_name"/levels/ --level 1

python3 FR_Ours/curve_fit_scene.py --root_dir /workspace/PowerGS/models/"$method_name"/"$scene_type"/"$scene_name"/levels/ --level 2
python3 FR_Ours/curve_fit_scene.py --root_dir /workspace/PowerGS/models/"$method_name"/"$scene_type"/"$scene_name"/levels/ --level 3
python3 FR_Ours/curve_fit_scene.py --root_dir /workspace/PowerGS/models/"$method_name"/"$scene_type"/"$scene_name"/levels/ --level 4
