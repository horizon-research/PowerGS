...
python render_Ln.py --iteration 35000 -s "$dataset_path" -m "$model_path"/L2 --quiet --eval --skip_train --FR_folder "$model_path" --Ln "L2"
python render_Ln.py --iteration 35000 -s "$dataset_path" -m "$model_path"/L3 --quiet --eval --skip_train --FR_folder "$model_path" --Ln "L3"
python render_Ln.py --iteration 35000 -s "$dataset_path" -m "$model_path"/L4 --quiet --eval --skip_train --FR_folder "$model_path" --Ln "L4"




python3 test_power_FR.py --iteration 30000 -s "$dataset_path" -m "$model_path"/L1 --eval --skip_train --FR_folder "$model_path"
# python /workspace/PowerGS/vr-power-saver/power_saver_demo.py --folder_path "$model_path"/L1/test/ph/renders --ecc 0
# python /workspace/PowerGS/vr-power-saver/power_saver_demo.py --folder_path "$model_path"/L2/test/phLn/renders --ecc 23
# python /workspace/PowerGS/vr-power-saver/power_saver_demo.py --folder_path "$model_path"/L3/test/phLn/renders --ecc 30
# python /workspace/PowerGS/vr-power-saver/power_saver_demo.py --folder_path "$model_path"/L4/test/phLn/renders --ecc 35
# python /workspace/PowerGS/vr-power-saver/power_saver_demo.py --folder_path "$model_path"/test/ph/renders_fov --fr
python metrics_hvsq.py -m "$model_path"/L1 -p 1
python metrics_hvsq.py -m "$model_path"/L2 -p 3
python metrics_hvsq.py -m "$model_path"/L3 -p 7
python metrics_hvsq.py -m "$model_path"/L4 -p 12
